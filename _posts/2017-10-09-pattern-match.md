...
as powerful as it could be. More importantly, when you get to that stage your
code looks horrible...!

Feeling frustrated with this, I wrote a python package called [concepts][0] that
gives you pattern matching and a number of other functional programming goodies.
So, let's take a look at how to pattern match in python!


## Enter 'with pattern_match' and '@pattern_matching'
You have a choice of using the `with pattern_match(foo) as m: ...` context manager
...
```
  ...
  [0]: https://github.com/sminez/concepts
